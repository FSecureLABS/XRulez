...
// Statics.
SERVICE_STATUS_HANDLE WinTools::Services::s_ServiceStatusHandle;
SERVICE_STATUS WinTools::Services::s_ServiceStatus;
WinTools::Services::AbstractService *WinTools::Services::s_Service;

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::pair<WinTools::Services::ReturnEnum, HRESULT> WinTools::Services::IsServiceInstalled(std::tstring const& serviceName)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::pair<WinTools::Services::ReturnEnum, HRESULT> WinTools::Services::InstallServiceSimple(std::filesystem::path const& binaryPath, std::wstring const& serviceName)
{
	// Open the Service Control Manager with full access
	SC_HANDLE manager = ::OpenSCManager(nullptr, nullptr, SC_MANAGER_ALL_ACCESS);
	if (!manager)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::pair<WinTools::Services::ReturnEnum, HRESULT> WinTools::Services::UninstallService(std::tstring const& serviceName)
{
	// Open the Service Control Manager with full access
	SC_HANDLE manager = ::OpenSCManager(nullptr, nullptr, SC_MANAGER_ALL_ACCESS);
	if (!manager)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CppTools::XError<HRESULT> WinTools::Services::TryStartAsService(AbstractService& theOnlyService, std::tstring const& serviceName)
{
	// Sanity check.
	if (s_Service)
		return WinTools::SystemErrorToHresult(ERROR_FILE_EXISTS);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::pair<WinTools::Services::Status, HRESULT> WinTools::Services::CheckStatus(std::tstring const& serviceName)
{
	// Open the Service Control Manager with full access
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WinTools::Services::ServiceMain(DWORD argc, LPTSTR* argv)
{
	// Register the control request handler
	if (s_ServiceStatusHandle = RegisterServiceCtrlHandler(TEXT("AdsaServicePoX"), ControlHandler), !s_ServiceStatusHandle)
	{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WinTools::Services::ControlHandler(DWORD opcode)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CppTools::XError<CppTools::SystemErrorCode> WinTools::Services::SetServiceStatus(DWORD state, DWORD waitHint, DWORD serviveExitCode)
{
	...
	s_ServiceStatus.dwCheckPoint = (state == SERVICE_RUNNING OR state == SERVICE_STOPPED ? 0 : checkPoint++);
